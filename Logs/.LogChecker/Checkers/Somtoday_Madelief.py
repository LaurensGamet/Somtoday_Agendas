...
log_file_path = '/home/laurens/logs/Somtoday_Madelief.log'
keywords = ["error", "failed", "exception", "fatal"]  # Keywords to detect

slack_webhook = Incoming_Webhook_URL
slack_message_template = {
        "username": "Somtoday Madelief",
        "text": "Warning!\nThe latest log contained an error!\n<https://github.com/LaurensGamet/Logchecker/blob/main/Somtoday_Madelief.log|Click here to view logs>",
	"icon_url": "http://188.90.170.38:8000/.madelief.jpg"
}
