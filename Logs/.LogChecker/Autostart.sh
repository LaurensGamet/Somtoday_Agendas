...
tmux send-keys -t Somtoday_Agendas:0.0 "sudo python3 /home/laurens/Somtoday_Agendas/Logs/.LogChecker/Checkers/Somtoday_Laurens.py" C-m

tmux send-keys -t Somtoday_Agendas:0.1 "sudo python3 /home/laurens/Somtoday_Agendas/Logs/.LogChecker/Checkers/Somtoday_Madelief.py" C-m 
